...
function broadwaydental_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'color_scheme', array(
		'default'           => 'default',
		'sanitize_callback' => 'broadwaydental_sanitize_color_scheme',
		'transport'         => 'postMessage',
	) );

	$wp_customize->add_control( 'color_scheme', array(
		'label'    => __( 'Base Color Scheme', 'broadwaydental' ),
		'section'  => 'colors',
		'type'     => 'select',
		'choices'  => broadwaydental_get_color_scheme_choices(),
		'priority' => 1,
	) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'sidebar_textcolor', array(
		'label'       => __( 'Header and Sidebar Text Color', 'broadwaydental' ),
		'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', 'broadwaydental' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_background_color', array(
		'label'       => __( 'Header and Sidebar Background Color', 'broadwaydental' ),
		'description' => __( 'Applied to the header on small screens and the sidebar on wide screens.', 'broadwaydental' ),
		'section'     => 'colors',
	) ) );
...
add_action( 'customize_register', 'broadwaydental_customize_register', 11 );

/**
 * Register color schemes for Twenty Fifteen.
 *
 * Can be filtered with {@see 'broadwaydental_color_schemes'}.
 *
 ...
 */
function broadwaydental_get_color_schemes() {
	return apply_filters( 'broadwaydental_color_schemes', array(
		'default' => array(
			'label'  => __( 'Default', 'broadwaydental' ),
			'colors' => array(
				'#f1f1f1',
				'#ffffff',
				'#ffffff',
		...
		'yellow'  => array(
			'label'  => __( 'Yellow', 'broadwaydental' ),
			'colors' => array(
				'#f4ca16',
				'#ffdf00',
				'#ffffff',
		...
		'purple'  => array(
			'label'  => __( 'Purple', 'broadwaydental' ),
			'colors' => array(
				'#674970',
				'#2e2256',
				'#ffffff',
...
if ( ! function_exists( 'broadwaydental_get_color_scheme' ) ) :
/**
 ...
 */
function broadwaydental_get_color_scheme() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	$color_schemes       = broadwaydental_get_color_schemes();
...
endif; // broadwaydental_get_color_scheme

if ( ! function_exists( 'broadwaydental_get_color_scheme_choices' ) ) :
/**
 ...
 */
function broadwaydental_get_color_scheme_choices() {
	$color_schemes                = broadwaydental_get_color_schemes();
...
endif; // broadwaydental_get_color_scheme_choices

if ( ! function_exists( 'broadwaydental_sanitize_color_scheme' ) ) :
/**
 ...
 */
function broadwaydental_sanitize_color_scheme( $value ) {
	$color_schemes = broadwaydental_get_color_scheme_choices();
...
endif; // broadwaydental_sanitize_color_scheme
 ...
 */
function broadwaydental_color_scheme_css() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	...
	$color_textcolor_rgb         = broadwaydental_hex2rgb( $color_scheme[3] );
	$color_sidebar_textcolor_rgb = broadwaydental_hex2rgb( $color_scheme[4] );
	$colors = array(
	...
	$color_scheme_css = broadwaydental_get_color_scheme_css( $colors );

	wp_add_inline_style( 'broadwaydental-style', $color_scheme_css );
}
add_action( 'wp_enqueue_scripts', 'broadwaydental_color_scheme_css' );
 ...
 * @since Twenty Fifteen 1.0
 */
function broadwaydental_customize_control_js() {
	...
	wp_localize_script( 'color-scheme-control', 'colorScheme', broadwaydental_get_color_schemes() );
}
add_action( 'customize_controls_enqueue_scripts', 'broadwaydental_customize_control_js' );
 ...
 * @since Twenty Fifteen 1.0
 */
function broadwaydental_customize_preview_js() {
	wp_enqueue_script( 'broadwaydental-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20141216', true );
}
add_action( 'customize_preview_init', 'broadwaydental_customize_preview_js' );
 ...
 */
function broadwaydental_get_color_scheme_css( $colors ) {
 ...
 * @since Twenty Fifteen 1.0
 */
function broadwaydental_color_scheme_css_template() {
	$colors = array(
	...
	?>
	<script type="text/html" id="tmpl-broadwaydental-color-scheme">
		<?php echo broadwaydental_get_color_scheme_css( $colors ); ?>
	</script>
	<?php
}
add_action( 'customize_controls_print_footer_scripts', 'broadwaydental_color_scheme_css_template' );
